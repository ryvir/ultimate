...
firebase.initializeApp({
  ...
  var playerId, playerRef, gameRef, playerLetter, currentLetter, board, metaBoard, squareOver, goal, gameOver, squares, overlay, thisId, boardRef, turn;
  ...
  function startGame() {
    ...
    firebase.auth().onAuthStateChanged(user => {
      ...
      const players = firebase.database().ref(`games/${code}/players`);
